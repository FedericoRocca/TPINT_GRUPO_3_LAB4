					...
					<form class="needs-validation" method="post" action="../ServletsCuentas" enctype="multipart/form-data">
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input class="form-control"  name="txtCBU" required="required" type="text" placeholder="Nº identidad + NªSucursal + Dígito identificador + Numero de cuenta + Dígito verificador">
							</div>
						</div>
						<div class="form-row">
