...
<%@page import="dominio.LisCantidadClientesPaises"%>
...
<title>Banco UTN - Listado de cantidad clientes por pais</title>
				...
				<div class="container-fluid">
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Listado de cantidad clientes por pais</h6>
						</div>					
						<div class="card-body">
							...
							<%
								...
								if (request.getAttribute("listResult") != null){
								    listResult = (ArrayList<LisCantidadClientesPaises>) request.getAttribute("listResult");
								}
							...
							%>	
								<table class="table table-bordered" id="dataTable" cellspacing="0">				
									...
									<% 
									if(listResult != null)
									for (LisCantidadClientesPaises results : listResult ) { %>							
										<tr>
					                      <td><%=results.getPais()%></td>
					                      <td><%=results.getCantidad()%></td>
					                    </tr>
					                <% } %>
									</tbody>
								</table>
