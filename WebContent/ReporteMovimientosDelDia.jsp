...
<%@page import="dominio.RepMovimientosDelDia"%>
				...
				<div class="container-fluid">
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Reporte de movimientos del día</h6>
						</div>					
						<div class="card-body">
							<div class="table-responsive">
							
							<%
								ArrayList<RepMovimientosDelDia> reportResult = new ArrayList<RepMovimientosDelDia>();
								
								if (request.getAttribute("reportResult") != null){
								    reportResult = (ArrayList<RepMovimientosDelDia>) request.getAttribute("reportResult");
								}
							%>	
								<table class="table table-bordered" id="dataTable" cellspacing="0">				
									...
									for (RepMovimientosDelDia results : reportResult ) { %>							
										<tr>
					                      <td><%=results.getAccount()%></td>
					                      <td><%=results.getMovementDate()%></td>
					                      <td><%=results.getDetail()%></td>
					                      <td><%=results.getAmount()%></td>
					                      <td><%=results.getMovementType()%></td>
					                    </tr>
					                <% } %>
									</tbody>
								</table>
